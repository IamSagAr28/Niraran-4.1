...
const Login = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-[#a3b18a]/30 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-300" onClick={onClose}>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {isSignUp && (
              <div className="animate-in fade-in slide-in-from-top-4 duration-300">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg border border-[#dad7cd]/60 text-gray-700 placeholder:text-gray-400 focus:border-[#588157] focus:outline-none focus:ring-2 focus:ring-[#588157]/20 transition-all duration-200"
                  required
                  minLength={2}
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg border border-[#dad7cd]/60 text-gray-700 placeholder:text-gray-400 focus:border-[#588157] focus:outline-none focus:ring-2 focus:ring-[#588157]/20 transition-all duration-200 pr-12"
                  required
                  minLength={6}
                />
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#588157] transition-colors duration-200 p-1"
                >
            ...
            {!isSignUp && (
              <div className="text-left">
                <button
                  type="button"
                  className="text-sm text-[#588157]/70 hover:text-[#588157] transition-colors duration-200"
                  onClick={() => {
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#588157] text-white py-3.5 rounded-lg font-semibold hover:bg-[#3a5a40] disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-[#dad7cd]/60 rounded-lg text-gray-700 hover:bg-gray-50 hover:border-[#588157]/40 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <div className="text-center pt-2">
              <button
                ...
                className="text-sm text-gray-500 hover:text-[#588157] transition-colors duration-200"
              >
                {isSignUp ? 'Already have an account?' : "Don't have an account?"}
                <span className="text-[#588157] hover:text-[#3a5a40] font-semibold ml-1 transition-colors duration-200">
